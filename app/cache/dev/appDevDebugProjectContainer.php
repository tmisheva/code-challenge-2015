...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'animal_provider' => 'getAnimalProviderService',
            ...
            'guzzle_client' => 'getGuzzleClientService',
    ...
    /**
     * Gets the 'animal_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \TimeInc\CatsVsDogsBundle\AnimalProvider\Giphy\GiphyProvider A TimeInc\CatsVsDogsBundle\AnimalProvider\Giphy\GiphyProvider instance.
     */
    protected function getAnimalProviderService()
    {
        return $this->services['animal_provider'] = new \TimeInc\CatsVsDogsBundle\AnimalProvider\Giphy\GiphyProvider($this->get('guzzle_client'), 'dc6zaTOxFJmzC');
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_73b1d86a11256650e98c5bdb8accf30bd66405530324ff0e648c2435be3dc376');
    ...
    /**
     * Gets the 'guzzle_client' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGuzzleClientService()
    {
        return $this->services['guzzle_client'] = new \GuzzleHttp\Client();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/TimeInc/CatsVsDogsBundle/Resources/views'), 'TimeIncCatsVsDogs');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55fc331e1cb448.05343626')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TimeIncCatsVsDogsBundle' => 'TimeInc\\CatsVsDogsBundle\\TimeIncCatsVsDogsBundle',
            ...
            'time_inc.cats_vs_dogs.api_key' => 'dc6zaTOxFJmzC',
